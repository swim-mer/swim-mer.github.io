...
<img width="560" alt="Screenshot of first working macOS App" src="{{site.url}}/assets/images/SwiftFirstmacOSApp.jpeg"/>
...
<img width="560" alt="Gif of app with text box reflecting user input text" src="{{site.url}}/assets/images/SwiftApp.gif"/>
...
<img width="560" alt="Gif of app that changes hero image to random cat photo when user clicks button" src="{{site.url}}/assets/images/ClickForRandomCat.gif"/>
...
<img width="560" alt="Gif of app that displays a Picker with a list of API tags when user types a character" src="{{site.url}}/assets/images/SelectTagForRelevantCat.gif"/>
...
<img width="560" alt="Gif of app that displays a Picker with filtered contents based on a user's text input" src="{{site.url}}/assets/images/FilterTagsByCharAndGetCat.gif"/>
